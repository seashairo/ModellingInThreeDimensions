...
// Creates a New matrix for the frustum planes based on the porjectionMatrix and the viewMatrix.
...
//Check if a single point is inside all the six planes of the view frustum;
