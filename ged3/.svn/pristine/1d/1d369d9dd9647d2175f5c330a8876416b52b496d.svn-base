...
BasicShaderClass::BasicShaderClass(const BasicShaderClass& other){
}
...
void BasicShaderClass::ShutdownShader(){
	m_effects = 0;
...
// Shutsdown the shader
void BasicShaderClass::Shutdown(){
	ShutdownShader();
	return;
}

void BasicShaderClass::Initialize(ID3D10Device* device){
	HRESULT result;
	...
	result = D3DX10CreateEffectFromFile(L"../ModellingInThreeDimensions/data/Basic.fx", NULL, NULL, "fx_4_0", D3D10_SHADER_ENABLE_STRICTNESS, 0, 
...
//Render generally
void BasicShaderClass::Render(ID3D10Device* device, int indexCount, int vertexCount, int instanceCount, D3DXMATRIX worldMatrix, D3DXMATRIX viewMatrix, D3DXMATRIX projectionMatrix, 
